...
parser.add_argument('--data', type=str,default="/data/ilsvrc12_torch",
                    help='path to dataset')
parser.add_argument('--save_dir', type=str, default='./temp', help='Folder to save checkpoints and log.')                    
parser.add_argument('-a', '--arch', metavar='ARCH', default='dynamicresnet18',
                    choices=model_names,
...
parser.add_argument('--resume_normal', default='', type=str, metavar='PATH',
...
parser.add_argument('--dist-url', default='tcp://172.10.60.151:1234', type=str,
...
parser.add_argument('--gpu', default=None, type=str,
                    help='GPU id to use.')
parser.add_argument('-mul-dis','--multiprocessing-distributed', action='store_true',
